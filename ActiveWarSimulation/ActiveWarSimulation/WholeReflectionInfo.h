...
struct WholeReflectionInfo{
	...
	//変数
	std::pair<SubmissionEvaluation,std::shared_ptr<const LogElement>> m_goodLog;//良い動きをしたとされる時の評価とログ
	std::pair<SubmissionEvaluation,std::shared_ptr<const LogElement>> m_badLog;//良くない動きをしたとされる時の評価とログ
};
