...
public:
	...
	void DrawUnit(Vector2D adjust,float angle,bool infoDrawFlag)const;//マップ上のユニットを描画
	void DrawUnit(Vector2D point,Vector2D adjust,float angle,bool infoDrawFlag)const;//マップ上のユニットを描画
