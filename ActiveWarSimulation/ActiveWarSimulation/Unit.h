...
public:
	...
	void DrawHPGage(Vector2D point,Vector2D adjust,float exRate)const;//HPゲージの描画
	...
	void DrawUnit(Vector2D point,Vector2D adjust,float exRate,size_t frame,bool animationFlag,bool infoDrawFlag,bool actionRangeDraw)const;//マップ上のユニットを描画
